      ...
      <div className='mt-20 flex flex-col-reverse lg:flex-row'>
        ...
        <div className='w-full px-10 lg:w-1/2 lg:pl-10'>
          ...
          <p className='mb-10 max-w-full text-sm leading-relaxed text-black lg:mb-0 lg:max-w-lg'>
            ...
            Putaendo. Una minería más verde, responsable y comprometida con la
            comunidad, sus necesidades y anhelos. Por eso incorporamos las
            innovaciones tecnológicas de la industria para desarrollar un
            proyecto que reduzca al máximo sus impactos, pero que además esté
            presente en el territorio, disponible para avanzar con todos
            aquellos que desean una mejor calidad de vida para la comuna, la
